...
Control bar order should be: scene-lock button, audio mute button, divider, segmented progress bar, scene counter, elapsed/total playback timer, collapse chevron.
