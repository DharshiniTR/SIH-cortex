---
name: mcp-supabase-541fb2e6
description: "Call tools from the \"Supabase\" MCP server through code_execution callbacks. Available tools: mcpSupabase_applyMigration_7289c10f, mcpSupabase_confirmCost_dfae78c8, mcpSupabase_createBranch_7d3c9c74, mcpSupabase_createProject_5f190cee, mcpSupabase_deleteBranch_07fbb267, mcpSupabase_deployEdgeFunction_5d5cb79a, mcpSupabase_executeSql_8a60f85d, mcpSupabase_generateTypescriptTypes_249f7014, mcpSupabase_getAdvisors_66d5ba5f, mcpSupabase_getCost_6c937cd3, mcpSupabase_getEdgeFunction_c0be80fb, mcpSupabase_getOrganization_032193cf, mcpSupabase_getProject_ee337013, mcpSupabase_getProjectUrl_4c6c3d46, mcpSupabase_getPublishableKeys_07ad1944, mcpSupabase_listBranches_f807055b, mcpSupabase_listEdgeFunctions_5c62fc91, mcpSupabase_listExtensions_9b3bac82, mcpSupabase_listMigrations_d6fbfb35, mcpSupabase_listOrganizations_910b8a95, and 9 more. Reference skill for more information."
---
...
### mcpSupabase_applyMigration_7289c10f(...)
...
```javascript
const result = await mcpSupabase_applyMigration_7289c10f({ "project_id": "", "name": "", "query": "" });
console.log(result);
```

### mcpSupabase_confirmCost_dfae78c8(...)
...
```javascript
const result = await mcpSupabase_confirmCost_dfae78c8({ "type": "project", "recurrence": "hourly", "amount": 0 });
console.log(result);
```

### mcpSupabase_createBranch_7d3c9c74(...)
...
```javascript
const result = await mcpSupabase_createBranch_7d3c9c74({ "project_id": "", "name": "develop", "confirm_cost_id": "" });
console.log(result);
```

### mcpSupabase_createProject_5f190cee(...)
...
```javascript
const result = await mcpSupabase_createProject_5f190cee({ "name": "", "region": "us-west-1", "organization_id": "", "confirm_cost_id": "" });
console.log(result);
```
...
```javascript
const result = await mcpSupabase_deleteBranch_07fbb267({ "branch_id": "" });
console.log(result);
```

### mcpSupabase_deployEdgeFunction_5d5cb79a(...)
...
```javascript
const result = await mcpSupabase_deployEdgeFunction_5d5cb79a({ "project_id": "", "name": "", "entrypoint_path": "index.ts", "import_map_path": "", "verify_jwt": true, "files": [] });
console.log(result);
```

### mcpSupabase_executeSql_8a60f85d(...)
...
```javascript
const result = await mcpSupabase_executeSql_8a60f85d({ "project_id": "", "query": "" });
console.log(result);
```

### mcpSupabase_generateTypescriptTypes_249f7014(...)
...
```javascript
const result = await mcpSupabase_generateTypescriptTypes_249f7014({ "project_id": "" });
console.log(result);
```

### mcpSupabase_getAdvisors_66d5ba5f(...)
...
```javascript
const result = await mcpSupabase_getAdvisors_66d5ba5f({ "project_id": "", "type": "security" });
console.log(result);
```

### mcpSupabase_getCost_6c937cd3(...)
...
```javascript
const result = await mcpSupabase_getCost_6c937cd3({ "type": "project", "organization_id": "" });
console.log(result);
```

### mcpSupabase_getEdgeFunction_c0be80fb(...)
...
```javascript
const result = await mcpSupabase_getEdgeFunction_c0be80fb({ "project_id": "", "function_slug": "" });
console.log(result);
```

### mcpSupabase_getOrganization_032193cf(...)
...
```javascript
const result = await mcpSupabase_getOrganization_032193cf({ "id": "" });
console.log(result);
```

### mcpSupabase_getProject_ee337013(...)
...
```javascript
const result = await mcpSupabase_getProject_ee337013({ "id": "" });
console.log(result);
```
...
```javascript
const result = await mcpSupabase_getProjectUrl_4c6c3d46({ "project_id": "" });
console.log(result);
```
...
```javascript
const result = await mcpSupabase_getPublishableKeys_07ad1944({ "project_id": "" });
console.log(result);
```
...
```javascript
const result = await mcpSupabase_listBranches_f807055b({ "project_id": "" });
console.log(result);
```
...
```javascript
const result = await mcpSupabase_listEdgeFunctions_5c62fc91({ "project_id": "" });
console.log(result);
```

### mcpSupabase_listExtensions_9b3bac82(...)
...
```javascript
const result = await mcpSupabase_listExtensions_9b3bac82({ "project_id": "" });
console.log(result);
```

### mcpSupabase_listMigrations_d6fbfb35(...)
...
```javascript
const result = await mcpSupabase_listMigrations_d6fbfb35({ "project_id": "" });
console.log(result);
```

### mcpSupabase_listOrganizations_910b8a95(...)
...
```javascript
const result = await mcpSupabase_listOrganizations_910b8a95();
console.log(result);
```

### mcpSupabase_listProjects_cca95905(...)
...
```javascript
const result = await mcpSupabase_listProjects_cca95905();
console.log(result);
```

### mcpSupabase_listTables_81b0c22f(...)
...
```javascript
const result = await mcpSupabase_listTables_81b0c22f({ "project_id": "", "schemas": ["public"], "verbose": false });
console.log(result);
```

### mcpSupabase_mergeBranch_c57c52de(...)
...
```javascript
const result = await mcpSupabase_mergeBranch_c57c52de({ "branch_id": "" });
console.log(result);
```

### mcpSupabase_pauseProject_9662416a(...)
...
```javascript
const result = await mcpSupabase_pauseProject_9662416a({ "project_id": "" });
console.log(result);
```

### mcpSupabase_queryLogs_00a3983c(...)
...
```javascript
const result = await mcpSupabase_queryLogs_00a3983c({ "project_id": "", "sql": "", "iso_timestamp_start": "", "iso_timestamp_end": "" });
console.log(result);
```

### mcpSupabase_rebaseBranch_7833dd38(...)
...
```javascript
const result = await mcpSupabase_rebaseBranch_7833dd38({ "branch_id": "" });
console.log(result);
```

### mcpSupabase_resetBranch_4e6b9676(...)
...
```javascript
const result = await mcpSupabase_resetBranch_4e6b9676({ "branch_id": "", "migration_version": "" });
console.log(result);
```

### mcpSupabase_restoreProject_97bcdad7(...)
...
```javascript
const result = await mcpSupabase_restoreProject_97bcdad7({ "project_id": "" });
console.log(result);
```

### mcpSupabase_searchDocs_55644275(...)
...
```javascript
const result = await mcpSupabase_searchDocs_55644275({ "graphql_query": "" });
console.log(result);
```
