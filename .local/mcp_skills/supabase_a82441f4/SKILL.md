---
name: mcp-supabase-a82441f4
description: "Call tools from the \"Supabase\" MCP server through code_execution callbacks. Available tools: mcpSupabase_applyMigration_a5dd2f22, mcpSupabase_confirmCost_7aae759c, mcpSupabase_createBranch_6f2ed4e6, mcpSupabase_createProject_7cfa660d, mcpSupabase_deleteBranch_63589d3f, mcpSupabase_deployEdgeFunction_0e51a0d5, mcpSupabase_executeSql_7be53b7e, mcpSupabase_generateTypescriptTypes_062c8f61, mcpSupabase_getAdvisors_e897693b, mcpSupabase_getCost_7ef16d94, mcpSupabase_getEdgeFunction_dadfe63b, mcpSupabase_getOrganization_467cddd8, mcpSupabase_getProject_327845d2, mcpSupabase_getProjectUrl_3d2d59f3, mcpSupabase_getPublishableKeys_94791e36, mcpSupabase_listBranches_822b9d1a, mcpSupabase_listEdgeFunctions_df3a07b7, mcpSupabase_listExtensions_0e526a44, mcpSupabase_listMigrations_da603219, mcpSupabase_listOrganizations_439b42e8, and 9 more. Reference skill for more information."
---
...
### mcpSupabase_applyMigration_a5dd2f22(...)
...
```javascript
const result = await mcpSupabase_applyMigration_a5dd2f22({ "project_id": "", "name": "", "query": "" });
console.log(result);
```

### mcpSupabase_confirmCost_7aae759c(...)
...
```javascript
const result = await mcpSupabase_confirmCost_7aae759c({ "type": "project", "recurrence": "hourly", "amount": 0 });
console.log(result);
```

### mcpSupabase_createBranch_6f2ed4e6(...)
...
```javascript
const result = await mcpSupabase_createBranch_6f2ed4e6({ "project_id": "", "name": "develop", "confirm_cost_id": "" });
console.log(result);
```

### mcpSupabase_createProject_7cfa660d(...)
...
```javascript
const result = await mcpSupabase_createProject_7cfa660d({ "name": "", "region": "us-west-1", "organization_id": "", "confirm_cost_id": "" });
console.log(result);
```

### mcpSupabase_deleteBranch_63589d3f(...)
...
```javascript
const result = await mcpSupabase_deleteBranch_63589d3f({ "branch_id": "" });
console.log(result);
```

### mcpSupabase_deployEdgeFunction_0e51a0d5(...)
...
```javascript
const result = await mcpSupabase_deployEdgeFunction_0e51a0d5({ "project_id": "", "name": "", "entrypoint_path": "index.ts", "import_map_path": "", "verify_jwt": true, "files": [] });
console.log(result);
```

### mcpSupabase_executeSql_7be53b7e(...)
...
```javascript
const result = await mcpSupabase_executeSql_7be53b7e({ "project_id": "", "query": "" });
console.log(result);
```

### mcpSupabase_generateTypescriptTypes_062c8f61(...)
...
```javascript
const result = await mcpSupabase_generateTypescriptTypes_062c8f61({ "project_id": "" });
console.log(result);
```

### mcpSupabase_getAdvisors_e897693b(...)
...
```javascript
const result = await mcpSupabase_getAdvisors_e897693b({ "project_id": "", "type": "security" });
console.log(result);
```

### mcpSupabase_getCost_7ef16d94(...)
...
```javascript
const result = await mcpSupabase_getCost_7ef16d94({ "type": "project", "organization_id": "" });
console.log(result);
```

### mcpSupabase_getEdgeFunction_dadfe63b(...)
...
```javascript
const result = await mcpSupabase_getEdgeFunction_dadfe63b({ "project_id": "", "function_slug": "" });
console.log(result);
```

### mcpSupabase_getOrganization_467cddd8(...)
...
```javascript
const result = await mcpSupabase_getOrganization_467cddd8({ "id": "" });
console.log(result);
```

### mcpSupabase_getProject_327845d2(...)
...
```javascript
const result = await mcpSupabase_getProject_327845d2({ "id": "" });
console.log(result);
```
...
```javascript
const result = await mcpSupabase_getProjectUrl_3d2d59f3({ "project_id": "" });
console.log(result);
```

### mcpSupabase_getPublishableKeys_94791e36(...)
...
```javascript
const result = await mcpSupabase_getPublishableKeys_94791e36({ "project_id": "" });
console.log(result);
```

### mcpSupabase_listBranches_822b9d1a(...)
...
```javascript
const result = await mcpSupabase_listBranches_822b9d1a({ "project_id": "" });
console.log(result);
```

### mcpSupabase_listEdgeFunctions_df3a07b7(...)
...
```javascript
const result = await mcpSupabase_listEdgeFunctions_df3a07b7({ "project_id": "" });
console.log(result);
```

### mcpSupabase_listExtensions_0e526a44(...)
...
```javascript
const result = await mcpSupabase_listExtensions_0e526a44({ "project_id": "" });
console.log(result);
```

### mcpSupabase_listMigrations_da603219(...)
...
```javascript
const result = await mcpSupabase_listMigrations_da603219({ "project_id": "" });
console.log(result);
```

### mcpSupabase_listOrganizations_439b42e8(...)
...
```javascript
const result = await mcpSupabase_listOrganizations_439b42e8();
console.log(result);
```

### mcpSupabase_listProjects_7c29499f(...)
...
```javascript
const result = await mcpSupabase_listProjects_7c29499f();
console.log(result);
```

### mcpSupabase_listTables_d12f2e25(...)
...
```javascript
const result = await mcpSupabase_listTables_d12f2e25({ "project_id": "", "schemas": ["public"], "verbose": false });
console.log(result);
```

### mcpSupabase_mergeBranch_e4fabbec(...)
...
```javascript
const result = await mcpSupabase_mergeBranch_e4fabbec({ "branch_id": "" });
console.log(result);
```

### mcpSupabase_pauseProject_98de1a36(...)
...
```javascript
const result = await mcpSupabase_pauseProject_98de1a36({ "project_id": "" });
console.log(result);
```

### mcpSupabase_queryLogs_6946d80f(...)
...
```javascript
const result = await mcpSupabase_queryLogs_6946d80f({ "project_id": "", "sql": "", "iso_timestamp_start": "", "iso_timestamp_end": "" });
console.log(result);
```

### mcpSupabase_rebaseBranch_c968837a(...)
...
```javascript
const result = await mcpSupabase_rebaseBranch_c968837a({ "branch_id": "" });
console.log(result);
```

### mcpSupabase_resetBranch_90133394(...)
...
```javascript
const result = await mcpSupabase_resetBranch_90133394({ "branch_id": "", "migration_version": "" });
console.log(result);
```

### mcpSupabase_restoreProject_cbbfac02(...)
...
```javascript
const result = await mcpSupabase_restoreProject_cbbfac02({ "project_id": "" });
console.log(result);
```

### mcpSupabase_searchDocs_811bfd47(...)
...
```javascript
const result = await mcpSupabase_searchDocs_811bfd47({ "graphql_query": "" });
console.log(result);
```
